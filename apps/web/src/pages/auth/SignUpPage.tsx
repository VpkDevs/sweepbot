    ...
    return (
      <div className="w-full max-w-sm text-center space-y-4">
        ...
        <p className="text-sm text-zinc-400">
          ...
          Click the link to activate your account and start tracking.
        </p>
        <button
  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {googleLoading ? (
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="px-2 bg-zinc-950 text-zinc-500">or sign up with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="password" className="block text-xs font-medium text-zinc-400 mb-1.5">
            Password <span className="text-zinc-600 font-normal">(min 8 chars)</span>
          </label>
          <div className="relative">
            <input
              id="password"
              ...
              minLength={8}
              placeholder="••••••••"
              className="w-full px-3 py-2 bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent pr-10"
            />
            <button
              type="button"
      ...
      <p className="text-center text-xs text-zinc-600">
        ...
        <a href="/terms" className="text-zinc-400 hover:text-zinc-300">Terms</a>
        {' '}and{' '}
      ...
      <p className="text-center text-sm text-zinc-500">
        ...
        <Link to="/sign-in" className="text-brand-400 hover:text-brand-300 font-medium transition-colors">
          Sign in
        </Link>
      </p>
    </div>
