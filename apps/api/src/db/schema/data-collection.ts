...
export const jackpotSnapshots = pgTable(
  ...
  (table) => ({
    platformTimeIdx: index('idx_jackpot_snapshots_platform_time').on(
      table.platformId,
      table.capturedAt.desc()
    ),
    typeTimeIdx: index('idx_jackpot_snapshots_type_time').on(
      table.jackpotType,
      table.capturedAt.desc()
    ),
    hashIdx: index('idx_jackpot_snapshots_hash').on(table.snapshotHash),
    valueIdx: index('idx_jackpot_snapshots_value').on(
      table.currentValue.desc(),
      table.capturedAt.desc()
    ),
 ...
 */
export const tosSnapshots = pgTable(
  'tos_snapshots',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    platformId: uuid('platform_id')
...
export const platformHealthChecks = pgTable(
  ...
  (table) => ({
    platformTimeIdx: index('idx_platform_health_platform_time').on(
      table.platformId,
