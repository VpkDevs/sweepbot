...
- Month 3: Jackpot history API and community data sharing
- Month 6: Aggregated jackpot value reports
...
4. **Month 3:** Expose aggregated jackpot history via the public API
5. **Month 6:** Publish first quarterly industry report
