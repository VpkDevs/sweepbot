import { z } from 'zod'
export declare const RedemptionStatus: z.ZodEnum<
  ['pending', 'processing', 'approved', 'rejected', 'received', 'cancelled']
>
export type RedemptionStatus = z.infer<typeof RedemptionStatus>
export declare const PaymentMethod: z.ZodEnum<
  ['paypal', 'check', 'ach', 'venmo', 'cashapp', 'giftcard', 'crypto', 'other']
>
...
export declare const RedemptionSchema: z.ZodObject<
  {
    ...
    paymentMethod: z.ZodNullable<
      z.ZodEnum<['paypal', 'check', 'ach', 'venmo', 'cashapp', 'giftcard', 'crypto', 'other']>
    >
...
export declare const UpdateRedemptionSchema: z.ZodObject<
  {
    status: z.ZodOptional<
      z.ZodEnum<['pending', 'processing', 'approved', 'rejected', 'received', 'cancelled']>
    >
