import { z } from 'zod';
export declare const SubscriptionTierSchema: z.ZodEnum<["free", "starter", "pro", "analyst", "elite", "lifetime"]>;
export type SubscriptionTier = z.infer<typeof SubscriptionTierSchema>;
export declare const SubscriptionStatusSchema: z.ZodEnum<["active", "trialing", "past_due", "cancelled", "paused"]>;
