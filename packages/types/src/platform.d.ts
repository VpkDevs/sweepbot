...
export declare const KNOWN_PLATFORM_SLUGS: readonly ["chumba-casino", "luckylandslots", "stake-us", "pulsz", "wow-vegas", "fortune-coins", "funrize", "zula-casino", "crown-coins-casino", "mcluck", "nolimitcoins", "modo-casino", "sweeptastic", "global-poker", "betrivers-net", "high5casino", "jackpota", "spree-casino", "sportzino"];
