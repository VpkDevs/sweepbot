...
- The `flows`, `flow_executions`, `flow_conversations`, `shared_flows` tables are in `apps/api/src/db/schema/flows.ts` — they are NOT yet in `docs/DATABASE_SCHEMA.md` (known gap)
...
| Phase 1 completion details | `docs/PHASE_1_COMPLETION.md` |
| Platform list | `docs/PLATFORM_COVERAGE.md` |
